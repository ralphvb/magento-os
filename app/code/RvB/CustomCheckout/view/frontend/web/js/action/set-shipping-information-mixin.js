define([
    ...
    return function (setShippingInformation) {
        return wrapper.wrap(setShippingInformation, function (originalAction) {
            ...
            const attribute = shippingAddress.customAttributes.find(el => el.attribute_code === attributeCode);
